...
namespace Magezon\Revisions\Model\ResourceModel\Block\Grid;
...
class Collection extends SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        $this->addFieldToFilter('revision_type', ['eq' => Config::REVISION_TYPE_BLOCK]);
        $blockId = $this->request->getParam('block_id');
        if($blockId !== null){
            $this->addFieldToFilter('entity_id', ['eq' => $blockId]);
        }
        return $this;
    }
}
